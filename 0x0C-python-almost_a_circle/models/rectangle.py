...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args:
            ...
            x (int): The x coordinate of the new Rectangle. Defaults to 0.
            y (int): The y coordinate of the new Rectangle. Defaults to 0.
    ...
    def display(self):
        ...
        for _ in range(self.height):
            #Print x-coordinate offset
            print(" " * self.x, end="")

            #Print '#' characters for the width
            print("#" * self.width)
